...
def evaluate_model_performance():
    ...
    print(
        f"Test Set Size: {len(test_ds)} samples (Randomly sampled, consistent with Training)")
    ...
    indentations = torch.linspace(
        0, max_d, cfg['data']['n_steps']).unsqueeze(0).to(device)
